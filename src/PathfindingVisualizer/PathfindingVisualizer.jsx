...
export default class PathfindingVisualizer extends Component {
  ...
  visualizeDijkstra() {
    this.setState({ topMessage: "Creator : Jai" });
  ...
  render() {
    ...
    } else if (topMessage === "Creator : Jai") {
    ...
    return (
      <div className="pathfindingVisualizer">
        <div className="container">
          ...
          {textBox}
          <p>
            Dijkstra's Algorithm is weighted and guarantess shortest path!{" "}
